...
**Observations**:
-Price tends increase with carat.
-It is not a lineear relationship.
-Vertical data "thresholds" might suggest there is another factor. 
...
- Carat seems to to be more correlated to price than the cut. 
- The highest carat is a fair cut, which might suggest that carat matters more than cut.
