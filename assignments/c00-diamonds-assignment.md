...
**Observations**: -Price tends increase with carat. -It is not a lineear
relationship. -Vertical data “thresholds” might suggest there is another
factor.
...
**Observations**:
  ...
  - Carat seems to to be more correlated to price than the cut. I like
    the way that the color brings out the price differences.
