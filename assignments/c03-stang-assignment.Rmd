...
- Is there "one true value" for the material properties of Aluminum? No, there is not one true value for the material properties of Aluminum. The measurements results vary.
- How many aluminum alloys were tested? How do you know? Only one type of aluminum alloy was tested. It is "al_24st". I confirmed that it is only "al_24st" with the following command "unique(df_stang_long$alloy)"
- What angles were tested? 0, 45, and 90 degrees.
- What thicknesses were tested? Four thicknesses: 0.022, 0.032, 0.064, & 0.081.
- My own question: I am curious if the porperties of `E, mu` vary more with angle or thickness.
...
- I see the greatest differentiation in the dots above by thickness. The thicker pieces of metal, tend to have lower values.
...
- No, I think the graph above does not necessarily support the claim above. The thicker peices of metal seem to have different E and Mu values.
